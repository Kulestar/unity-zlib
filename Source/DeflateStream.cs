...
namespace Zlib
{
    ...
    public class DeflateStream : System.IO.Stream
    {
        ...
        {
            _innerStream = stream;
            _baseStream = new ZlibBaseStream(stream, mode, level, leaveOpen);
        }
		
		public void SetDataToRead(int size){
			_baseStream.ChangeDataToRead(size);
		}
		
		public void ChangeStream(System.IO.Stream stream){
			_innerStream = stream;
			_baseStream.ChangeStream(stream);
		}
